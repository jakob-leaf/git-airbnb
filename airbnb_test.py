...
cursor = db.cursor()
cursor.execute('DROP DATABASE IF EXISTS airbnb_test;')
cursor.execute('CREATE DATABASE airbnb_test;')

db = mysconnect.connect(host = 'localhost', user = 'root', password = '', database = 'airbnb_test')
cursor = db.cursor()
